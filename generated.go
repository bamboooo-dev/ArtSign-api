...
type WorkResolver interface {
	Parent(ctx context.Context, obj *ent.Work) (*ent.Work, error)
	Children(ctx context.Context, obj *ent.Work) ([]*ent.Work, error)
}
...
func (ec *executionContext) _Work_parent(ctx context.Context, field graphql.CollectedField, obj *ent.Work) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Work().Parent(rctx, obj)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Work_children(ctx context.Context, field graphql.CollectedField, obj *ent.Work) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Work().Children(rctx, obj)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
