...
func (e CategoryEdges) WorksOrErr() ([]*Work, error) {
	if e.loadedTypes[0] {
		return e.Works, nil
	}
...
// QueryWorks queries the "works" edge of the Category entity.
func (c *Category) QueryWorks() *WorkQuery {
	return (&CategoryClient{config: c.config}).QueryWorks(c)
}
