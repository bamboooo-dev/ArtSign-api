...
func (w *Work) Node(ctx context.Context) (node *Node, err error) {
	...
	if buf, err = json.Marshal(w.Height); err != nil {
		return nil, err
	}
	node.Fields[2] = &Field{
		Type:  "float64",
	...
	if buf, err = json.Marshal(w.Width); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "float64",
	...
	if buf, err = json.Marshal(w.SizeUnit); err != nil {
		return nil, err
	}
	node.Fields[4] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(w.Year); err != nil {
		return nil, err
	}
	node.Fields[5] = &Field{
		Type:  "int",
	...
	if buf, err = json.Marshal(w.Month); err != nil {
		return nil, err
	}
	node.Fields[6] = &Field{
		Type:  "int",
